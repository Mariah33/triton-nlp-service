...
class TritonPythonModel:
    ...
    def initialize(self, args):
        ...
        self.entity_patterns = {
            'PERSON': {
                ...
                'common_first_names': ['John', 'Jane', 'Michael', 'Sarah', 'David', 'Emma', 'James', 'Mary'],
                'common_last_names': ['Smith', 'Johnson', 'Brown', 'Jones', 'Miller', 'Davis', 'Garcia', 'Wilson']
            },
            'ORGANIZATION': {
                'suffixes': ['Inc.', 'Corp.', 'LLC', 'Ltd.', 'Co.', 'Company', 'Corporation', 'Group', 'Industries'],
                'keywords': ['Google', 'Microsoft', 'Apple', 'Amazon', 'Facebook', 'Tesla', 'IBM', 'Oracle']
            },
            'LOCATION': {
                'countries': ['United States', 'USA', 'UK', 'United Kingdom', 'Canada', 'Australia', 'Germany', 'France', 'India', 'China', 'Japan'],
                'cities': ['New York', 'London', 'Paris', 'Tokyo', 'Sydney', 'Mumbai', 'Berlin', 'Toronto', 'Singapore', 'Dubai'],
                'keywords': ['Street', 'Avenue', 'Road', 'Boulevard', 'Lane', 'Drive', 'Court', 'Plaza']
            },
            'DATE': {
    ...
    def execute(self, requests):
        ...
        for request in requests:
            ...
            out_tensor = pb_utils.Tensor(
                "entities",
                np.array(ner_results, dtype=np.object_))
    ...
    def _extract_persons(self, text: str) -> List[Dict[str, Any]]:
        ...
        for match in matches:
            ...
            is_likely_name = any(
                word in self.entity_patterns['PERSON']['common_first_names'] or 
                word in self.entity_patterns['PERSON']['common_last_names'] 
